...
//|  - Session 06:00-23:00 Moscow time.                               |
...
//|  - Maximum spread: 0.50 XAUUSD price units.                       |
//|  - No additional delay between entries.                           |
//|                                                                  |
//| Arrow legend:                                                     |
//|  Green filled up  = BUY entry                                    |
//|  Green hollow down = close BUY                                   |
//|  Red filled down   = SELL entry                                  |
//|  Red hollow up     = close SELL                                  |
//+------------------------------------------------------------------+
